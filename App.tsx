        ...
        <main className="mt-8 space-y-8">
          <div className="bg-slate-800/50 rounded-xl p-6 shadow-lg border border-slate-700">
            ...
            <button
              ...
              disabled={isLoading}
              className="mt-6 w-full flex items-center justify-center gap-2 bg-cyan-500 hover:bg-cyan-600 disabled:bg-cyan-800 disabled:text-slate-400 disabled:cursor-not-allowed text-white font-bold py-3 px-4 rounded-lg transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-cyan-300/50"
            >
              {isLoading ? (
                <>
                  <Loader />
